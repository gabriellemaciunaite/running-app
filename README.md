...
## Usage
Access to a **live demo** can be found [here](https://running-app-iam1.onrender.com) (note only pre-approved accounts can link to Google Fit, and automated synchronization is disabled in this demo).\
